...
% TODO: Nezapomenout zmínit lidi co mají šířit mylný dojem že se snaží získat informaci, i když se jí nesnaží získat. Demonstrace toho, jak lehká náhodnost může vést k paranoye.
...
\textbf{Měsíc} & \textbf{Učivo (počet výukových bloků)} & \textbf{Hodiny} \\ \hline
    ...
    Říjen &
        ...
        Internetový scam (2x) \newline
        Obrana pro Internetovému scamu (2x) &
        2 \newline 2 \newline 2 \newline 2
        \\ \hline
